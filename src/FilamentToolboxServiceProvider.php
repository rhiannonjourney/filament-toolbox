        ...
        $package->name(static::$name)
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->publishMigrations()
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('unexpectedjourney/filament-toolbox');
            });
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filament-toolbox/{$file->getFilename()}"),
                ], 'filament-toolbox-stubs');
            }
        }

        // Testing
        Testable::mixin(new TestsFilamentToolbox());
    }

    protected function getAssetPackageName(): ?string
    {
        return 'unexpectedjourney/filament-toolbox';
    }
